...
export function TransactionMessage({ animateInMessage,setAnimateInMessage, transactionMessage, setTransactionMessage,symbol , buyingQuantities}: transactionMessageProps) {
  ...
  return (
    <div className="toast animate-slide-in h-[100px] w-[25vw] bottom-[20px] right-[20px] rounded-[10px] bg-slate-100 z-102 fixed flex shadow-2xl  duration-200 p-3 gap-4 transition-transform duration-500" style={{transform: `${animateInMessage? 'translateX(0)' : 'translateX(100vw)'}`}} >
