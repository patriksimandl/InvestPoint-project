...
export function LoginOverlay({setShowLogin,showLogin,loginTransition, setLoginTransition}: LoginOverlayProps) {
  ...
  return (
    <>
      ...
      <div className={`fixed top-[0] bottom-0 shadow-xl w-[88vw] sm:w-[60vw] md:w-[40vw] lg:w-[30vw] right-[-88vw] sm:right-[-60vw] md:right-[-40vw] lg:right-[-30vw] flex flex-col justify-center items-center p-[15px] bg-white rounded-l-[8px] gap-8 sm:gap-12 z-102 transition-all`} style={{transform: `${loginTransition ? 'translateX(-100%)' : 'translateX(100%)'}`}}>
        ...
        <div className="text-[22px] sm:text-[25px] font-semibold w-full max-w-[520px] mt-[4vh] text-center px-3">
