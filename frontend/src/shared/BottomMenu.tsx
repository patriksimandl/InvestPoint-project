...
export function BottomMenu({isLogged} : {isLogged: boolean}) {
  const winUrl = window.location.pathname; 


  return (
    <div className="border-t-[2px] border-slate-300 px-[8%] flex w-full">
      
        <div className='flex flex-col w-[25%]'>
          <NavLink to={'/'} >
            <img src={InvestPointLogo} className='w-50' />
          </NavLink>
          <div className='text-slate-500 mt-[-30px] mb-[40px]'>
            The modern standard for global investments. Regulated and secure platform for traders worldwide.
          </div>
          <div className='flex gap-5 pb-10'>
            <NavLink to='https://cz.pinterest.com/pin/1117174251305801816/' className='flex justify-center items-center rounded-[100px] bg-slate-200 w-[40px] h-[40px]'>
            ...
            <NavLink to='/stocks' className='flex justify-center items-center rounded-[100px] bg-slate-200 w-[40px] h-[40px]'>
        ...
        <div className='grid grid-cols-3 font-semibold  mt-15 px-10 justify-around w-full' >
          <NavLink to={'/'} className='flex justify-center'>
            Home
          </NavLink>
          <NavLink to={'/portfolio'} className='flex justify-center'>
            Portfolio
          </NavLink>
          {isLogged && winUrl === '/stocks' ? <div>
          </div> : ''}
          <NavLink to={'/Stocks'} className='flex justify-center'>
            Stocks
          </NavLink>
